...
# To retrieve agenda from links in resultats_famfoot.txt

def build_tab_agenda(html, url, g, bonnedate, champ_name, coupe, slug):
    datelist = []
    for date in bonnedate:
        datelist.append(famfoot.retrieve_date(html, date, coupe))
...
g = open("agenda.json", "w")
datefile = open("date_agenda.json", "w")
